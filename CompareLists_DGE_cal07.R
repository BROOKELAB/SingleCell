...
fdr_min <- 0.01
out <- "results/CompareLists_DGE/2020-04-20_cal07_SigGenes_"

inMAST1 <- "results/Seurat_output/cal07_Seurat_MAST_DGElist_InfectedCells_"
inMAST2 <- "_2020-04-13.txt"

inNBID1 <- "results/NBID_output/2020-04-18-cal07_Scran_NBID_InfectedCells_"
inNBID2 <- ".txt"
...
write.csv(allDGE, file = "results/CompareLists_DGE/2020-04-20_cal07_SigCounts.csv",
          row.names = FALSE)
