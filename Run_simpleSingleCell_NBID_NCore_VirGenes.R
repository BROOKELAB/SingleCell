...
out <- args[2]
procs <- as.integer(args[3])          ###procs: number of processors to use DISABLED: NOT FUNCTIONING CORRECTLY
...
result = DEUsingNBID(counts,index_sub,sizeFactor = scranFactors)
